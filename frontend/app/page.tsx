...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      {/* Recommended for You */}
      <section id="recommended-products" className="container mx-auto px-6 lg:px-8 py-16 sm:py-20">
        <RecommendationSection userId={1} />
      </section>

      {/* All Products */}
      <section id="all-products" className="container mx-auto px-6 lg:px-8 py-16 sm:py-20 bg-muted/20">
